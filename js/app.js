...
function rebuildCalibrationUI(){
  ...
  Object.keys(calibrationData).forEach(elementId=>{
    ...
    valR.textContent = item.rotation + "°";
...
/* Senior Member only ribbons list for filtering in UI when cadet is selected */
const SM_ONLY_RIBBONS = [
  ...
  "Brig Gen Charles E. Yeager Aerospace Education Achievement Ribbon",
...
id          unique key (also used for image lookup)
name        display label
img         relative path in images/ribbons
smOnly      true if seniors-only
precedence  1 = highest precedence in rack
devices     array of {value,label} for per-ribbon dropdown
*/
const RIBBONS = [
...
/*
miniMedalImages maps ribbon id -> miniature medal image path.
Used when we render Mess Dress / Semi-formal (mini medals instead of ribbons).
Any ribbon without an entry here will just not show in mini-medal mode, which is fine.
*/
const miniMedalImages = {
  /* Valor / lifesaving / high decorations */
  ...
  "silver_lifesaving_medal":"images/medals/lifesaving_silver.png",
  "bronze_lifesaving_medal":"images/medals/lifesaving_bronze.png",

  /* High service & commendation */
  ...
  "national_commander_unit_citation_award":"images/medals/national_commander_unit_citation.png",
  "unit_citation_award":"images/medals/unit_citation.png",
  "crisis_ribbon":"images/medals/crisis_service.png",
  "red_service_ribbon":"images/medals/red_service.png",

  /* Ops / mission / specialty / qualification / community */
  ...
  "command_service_ribbon":"images/medals/command_service.png",
  "cadet_orientation_pilot_ribbon":"images/medals/orientation_pilot.png",
  "community_service_ribbon":"images/medals/community_service.png",
  "iace_ribbon":"images/medals/iace.png",
  "world_war_2_service_ribbon":"images/medals/world_war_2_service.png",
  "cap_membership_award_ribbon":"images/medals/membership.png",
  "senior_recruiter_ribbon":"images/medals/recruiting.png",

  /* Aerospace / PD / academics / AE achievements */
  "yeager_ribbon":"images/medals/charles_yaeger.png",
  "a_scott_crossfield_ribbon":"images/medals/a_scott_crossfield.png",
  "grover_loening_aerospace_ribbon":"images/medals/grover_loening.png",
  "paul_e_garber_ribbon":"images/medals/paul_e_garber.png",
  "gill_robb_wilson_ribbon":"images/medals/gill_robb_wilson.png",
  "leadership_award_ribbon":"images/medals/leadership.png",
  ...
  /* Phase achievements (optional miniature art if you have it) */
  "armstrong_achievement":"images/medals/armstrong.png",
  "goddard_achievement":"images/medals/goddard.png",
  "doolittle_achievement":"images/medals/doolittle.png",
  "lindbergh_achievement":"images/medals/lindbergh.png",
  "rickenbacker_achievement":"images/medals/rickenbacker.png",
  "mary_feik_achievement":"images/medals/mary_feik.png",
  "hap_arnold_achievement":"images/medals/hap_arnold.png",
  "curry_achievement":"images/medals/curry.png",

  /* Participation / activities / competitions */
  "national_cadet_competition_ribbon":"images/medals/cadet_competition.png",
  "national_color_guard_competition_ribbon":"images/medals/color_guard_competition.png",
  "cadet_advisory_council_ribbon":"images/medals/cadet_advisory_council.png",
  "cadet_special_activity_ribbon":"images/medals/cadet_special_activity.png",
  "encampment_ribbon":"images/medals/encampment.png",
  "cadet_recruiter_ribbon":"images/medals/recruiting.png",

  /* External org awards */
  "afa_award":"images/medals/afa_award.png",
  "afsa_award":"images/medals/afsa_award.png",
  "vfw_officer_award":"images/medals/vfw_officer_award.png",
  "vfw_nco_award":"images/medals/vfw_nco_award.png"
};

/* per-device metadata for multi-apply tool and per-ribbon devices */
const deviceList = [
...
/*
renderRack():
- builds ribbon rows with precedence rules
- rows touch vertically (no extra vertical gap)
- bottom row (lowest precedence) is anchored; higher rows go above
- also handles Mess Dress / Semi-formal mini medals
*/
function renderRack(){
  ...
  if(!useMini && uniformAllowsRibbons){
    ...
    rowsTopFirst.forEach((row,topIndex)=>{
      ...
      // vertical stacking: each row sits exactly one ribbon-height above
...
function getRibbonDevice(ribbonId){
  ...
  if(!r) return "";
  // if exactly one device type with qty>0, return that
...
function setRibbonDevice(ribbonId, deviceVal){
  ...
  if(deviceVal===""){
    ...
    r.devices={};
    r.devices[deviceVal]=1; // default qty 1
  }
}
...
memberSelect.addEventListener('change', ()=>{
  ...
  if(State.member==='cadet' && !isUniformAllowedFor(State.uniform,'cadet')){
    ...
    // purge SM-only ribbons while switching to cadet
